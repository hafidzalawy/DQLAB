-- Buat tabel 'tr_penjualan' jika belum ada
...
-- Masukkan data ke tabel 'tr_penjualan'
INSERT INTO tr_penjualan (kode_transaksi, kode_pelanggan, no_urut, kode_produk, nama_produk, qty, harga)
VALUES
